...
?>
      <div class="show_content">
               <img src="/textbook_picture/<?php echo $row['picture']?>" alt="<?php echo $row['heading']?>视屏教学" width="180" height="227" />
         
         <div class="content_infor">
               <h1><b><i><p class="content_mingzi"><a target="_blank" href="intro.php?id=<?php echo urlencode($row['id'])?>"><?php echo $row['heading']?></a></p></i></b></h1>
                       <div class="content_a">
                   ...
                   <div class="infor_hidden">
                       ...
                       <p class="content_shijian">学校：<?php echo $row['school']?></p>
                       <p class="content_shijian">专业：<?php echo $row['subject']?></p>
                       <p class="content_shijian">教材版本：<?php 
	$jiaocai=explode("*",$row['textbook_information']);
	echo mb_substr($jiaocai[0].'—'.$jiaocai[1], 0, 9, 'utf-8').'…';?></p>
                        <p class="content_shijian">所属专辑：<a  href="/examination/video_topics.php?sort=4&category=<?php echo $category?>&type=0&series=<?php echo $series_id?>"><?php echo $series_name?></a></p>
...
$arr11=array();
$add=0;
$query10="SELECT * FROM examination WHERE category='$category' AND pass>'0' AND series_id>'0'";
...
?>
      <div class="show_content">
               <img src="/textbook_picture/<?php echo $row['picture']?>" alt="<?php echo $row['series_name']?>视屏教学" width="180" height="227" />
         
         <div class="content_infor">
               <p class="content_mingzi"><a href="<?php $url="?sort=4&category=$category&search=$serch_text&type=0&series=$row[id]"; echo $_server['php_self'].$url ?>"><h1><b><i><?php echo $row['series_name']?></i></b></h1></a></p>
               <div class="content_a">
...
</div><?php }}else{echo 本课程暂无专辑;}}//有内容，可呈现结束//成套视频结束
//显示套结束
