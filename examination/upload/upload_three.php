...
if(strlen_utf8($heading)<1||strlen_utf8($heading)>50){$upload_mark=1;$error=$error.'标题长度应该大于1小于30<br />';}
//价格验证
...
//插入数据
if($upload_mark==0){
	$query="INSERT INTO examination (category,heading,video,summary,attachment,price,title_picture,user_id,series_id,school,subject) values('$category','$heading','$video','$summary','$attachment','$price','$title_picture','$user_id','$series_id','$school','$subject')";
