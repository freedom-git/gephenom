...
$series_title_picture=mysqli_real_escape_string($dbc,trim($_POST['series_title_picture2']));
if(!empty($series_name)){

$query="INSERT INTO examination_series (user_id,series_name,title_picture) VALUE ('$_SESSION[session_user_id]','$series_name','$series_title_picture')";
...
$query3="SELECT * FROM examination_series WHERE series_name='$series_name'";
