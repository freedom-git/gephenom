...
?>
<title>大学课程视频-大学课程视频教学-聚峰网</title>
<meta name="description" content="在这里同学们可以找到各大学各专业的不同课程的视频课程，包括大学基础课，如高等数学、随机数学、线性代数，和各专业专业课。"/>
<meta name="keywords" content="视频教学，大学课程，聚峰网"/>
<link href="examination_topics.css" rel="stylesheet" type="text/css">
</head>
<?php
...
<div class="_210" id="_<?php echo $i?>"><div class="jiantou">&gt;</div>
        <h1><b><i><p class="word"><?php echo $row['class0']?></p></i></b></h1><br /></div>
...
?>
	...
	$i_1=0;
	 foreach($zu as $zu){?>
    <a class="xiaoxiang" href="video_topics.php?category=<?php echo $xiao[$i_1]?>"><h2><b><i><?php echo $zu?></i></b></h2></a>
 <?php $i_1++;}?>
    </div>
</div>  
