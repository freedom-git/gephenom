...
"INNER JOIN examination AS t ON(t.id=b.examination_id) ".
...
<div class="video_infor_container">
  <div class="infor_content">
    <div class="infor_mingzi infor_con">
      <p><a target="_blank" href="/examination/intro.php?id=<?php echo $row['tid']?>" class="font_1a"><?php echo $row['heading']?></a></p>
