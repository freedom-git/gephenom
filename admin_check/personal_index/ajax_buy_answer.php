...
$search_text=mysqli_real_escape_string($dbc,trim($_POST['search']));
 ...
 ?>
<div class="buy_video">
  <p class="buy_video_tittle">我购买的学习资料</p>
...
<p class="search_res1 res_left">已为您列出:</p><p class="search_res2"></p><p class="search_res1">笔交易记录</p>
  <ul class="buy_video_ul">
    ...
    <li class="video_li video_5">下载次数</li>
  </ul>
  <?php
...
$.get(
'ajax_buy_answer_data.php?search=<?php echo urlencode($search_text)?>',
{},
function(response)
{
...
$('#submit').bind
	...
	$.post('ajax_buy_answer.php',buy_video,function(buy_video){
