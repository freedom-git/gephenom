...
$query_user_information="SELECT * FROM user WHERE id=$_SESSION[id]";
	...
	<div class="personal_right">
     ...
     <!--       <div class="my_account">
            ...
            <div class="my_account">
                ...
                <div class="my_account3_div"><p class="account_infor">可&nbsp;用&nbsp;余&nbsp;额：&nbsp;&nbsp;&nbsp;&nbsp;<span class="my_account3_span"><?php echo $_SESSION['money'];?></span>&nbsp;&nbsp;&nbsp;&nbsp;学币&nbsp;&nbsp;&nbsp;&nbsp;</p></div>
            </div>
		</div>  <!--end_right_count-->
