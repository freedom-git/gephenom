...
if(isset($_SESSION['id'])){$_SESSION['person']=$_SESSION['id'];}}
if(!isset($_GET['nickname'])&&!isset($_SESSION['id'])){exit;}
//区分用户
...
<div class="personal_right">
       ...
       <!--end_right_count-->
       <p class="buy_video_tittle"><?php if(isset($_GET['nickname'])){echo $_GET['nickname'];}else{echo $_SESSION['nickname'];}?>的个人主页</p>
<div class="table">
