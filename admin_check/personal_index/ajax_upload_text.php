...
<div class="buy_video">
	...
	if(isset($_SESSION['person'])){
		...
		echo $row['nickname'];}else{echo '我';}?>上传的大学课程</p>
...
$.get(
'ajax_upload_text_data.php?search=<?php echo urlencode($search_text);if(isset($_SESSION['person'])){echo '&person='.$_SESSION['person'];}?>',
{},
function(response)
{
counter++;
...
$('#submit').bind
	...
	$.post('ajax_upload_text.php',buy_video,function(buy_video){
