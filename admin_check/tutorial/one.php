  ...
  <div class="one_con">
    ...
    <div class="right">
      ...
      <div class="one_container">
        <div class="one_sel">
          <div class="sel_free sel_hover"> <a href="upload/upload.php">上传视屏教程</a> </div>
          <div class="sel_pay sel_hover"> <a href="video_topics.php?category=<?php echo $_GET['category'];?>">观看视屏教程</a> </div>
        </div>
      </div>
      <!--one_container--> 
    </div>
