...
?>
      <div class="show_content">
               <img src="/tutorial/tutorials/<?php echo $row['title_picture']?>" alt="呀！木有图！" width="220" height="140" />
...
////////////////////////////////////////////
if(!empty($_SESSION['manager_authority'])&&empty($_GET['category'])){
$query10="SELECT series_id FROM tutorial WHERE pass='0'";
	}else{
$query10="SELECT series_id FROM tutorial WHERE category='$category' AND pass>'0'";
	}////////////////////////////////////////////
