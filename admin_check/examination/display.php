...
if($grade==1){
$query22="UPDATE examination SET pass='$_SESSION[manager_id]' WHERE id='$id' LIMIT 1";
...
$query22="UPDATE examination SET pass='-1' WHERE id='$id' LIMIT 1";
$result22=mysqli_query($dbc,$query22) or die('错误');
 $xinxi0='该教程审核已删除';
 //开始发信息
$address="$row23[email]";
  ...
  <div id="page">
		...
		/>
          ...
          <?php
           ...
           <EMBED src="/examination/examinations/<?php echo $url;?>" allowfullscreen="true" quality=high bgcolor="#000000"  WIDTH=900 HEIGHT=628 TYPE="application/x-shockwave-flash" PLUGINSPAGE="http://www.macromedia.com/shockwave/download/index.cgi?P1_Prod_Version=ShockwaveFlash" flashvars="specialcode=www.gephenom.com"></EMBED>
                </div>        
...
<script type="text/javascript">
			...
			{  
					...
					$('#submit_to_examination').attr('disabled',true);
	                    var mark1;
	                    var mark2;
	                    var mark3;
	                    var mark4;
	                    var mark5;
	                     ...
	                     $('#submit_to_examination').removeAttr('disabled');
	                         }
	                     }
	                      return false;
	                     	}); 
