...
<div class="comment_tittle">                                  
<?php     
$query_zhuanji="SELECT * FROM examination WHERE series_id='$row_series[id]'";
...
?>                                  
 <div class="comment2">
   <div class="comment_infor">
     <div class="comment_left">
        <a href="/examination/intro.php?id=<?php echo $row1_zhuanji['id']?>"><p class="comment_a"><?php echo $row1_zhuanji['heading']?></p></a>
...
<?php }?></div></div></div>
            ...
            <div class="intro_ads"><img src="/examination/img/u=2,972069782&fm=19&gp=0.jpg" width="100%" height="2000px"></div>
        </div>
     </div> 
  </div>
</div>
