...
<div id="frame">
  ...
  <div class="tell">
    <p class="tell1">请选择您资料所属的专题<br />
    </p>
    <p class="tell2">如果没有找到您想要的专题，请<a href="/textbook_picture/textbook.php?type=s&new=1&free=<?php echo $free?>">点击这里</a>新建专题</p>
  </div>
  <div id="page">
    <div id="_21">
      <div class="_2100"></div>
...
?>
	...
	$i_1=0;
	 foreach($zu as $zu){?>
          <a class="xiaoxiang" href="/textbook_picture/textbook.php?type=s&new=2&category=<?php echo $xiao[$i_1]?>&free=<?php echo $free?>"><?php echo $zu?></a>
          <?php $i_1++;}?>
        </div>
      </div>
      <?php 
