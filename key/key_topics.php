...
?>
<title>学习资料-大学课程课后答案-聚峰网</title>
<meta name="description" content="在这里同学们可以找到各大学各专业的不同课程的学习资料、课后答案、考试试卷等，包括大学基础课，如高等数学、随机数学、线性代数，和各专业专业课。"/>
<meta name="keywords" content="学习资料，课后答案，聚峰网"/>
...
?>
	...
	$i_1=0;
	 foreach($zu as $zu){?>
    <a class="xiaoxiang" href="key3.php?category=<?php echo $xiao[$i_1]?>"><?php echo $zu?></a>
 <?php $i_1++;}?>
    </div>
</div>  
