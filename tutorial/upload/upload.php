...
?>
<title>视频教程上传-聚峰网</title>
<meta name="description" content="在这里同学们可以上传自己录制的教程到聚峰网,聚峰网致力于打造最优秀的视频教程网站，开创软件教程|大学课程|学习资料三大板块，拥有平面教程，多媒体制作教程，办公信息化教程，机械设计教程，网站制作教程，各专业大学课程，课后答案，学习资料等多种优质资源。"/>
<meta name="keywords" content="上传视频教程，聚峰网"/>
	...
	<div class="one_con">
		<div class="left">
			<div class="left_select">
				<h1>上传>软件教程</h1>
				<div class="tow">
					<p id="personal_2" class="tow_p"><a href="/examination/upload/upload.php">上传大学课程</a></p>
		...
		<div class="right">
			...
			<div class="one_container">
				<div class="one_sel">
					<div class="sel_free sel_hover"> <a href="upload_one.php?free=1">上传免费教程</a> </div>
					<div class="sel_pay sel_hover"> <a href="upload_one.php?free=2">上传付费教程</a> </div>
				</div>
			</div>
			<!--one_container--> 
		</div>
