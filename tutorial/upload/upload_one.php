...
<div id="frame">
	<div class="tell">
		...
		<p class="tell2">如果没有找到您想要的专题，请<a href="upload_two.php?new=1&free=<?php echo $free?>">点击这里</a>新建专题</p>
	</div>
	<div id="page">
		<div id="_21">
			<div class="_2100"></div>
...
?>
	...
	$i_1=0;
	 foreach($zu as $zu){?>
					<a class="xiaoxiang" href="upload_two.php?new=2&category=<?php echo $xiao[$i_1]?>&free=<?php echo $free?>"><?php echo $zu?></a>
					<?php $i_1++;}?>
				</div>
			</div>
			<?php 
...
function dosomething()
{
	...
	$('#_4').mouseenter(function(){
		$('._211').hide();
		$("#_04").css('margin-top','165px');
		$("#_04").show();
		})
	$('#_5').mouseenter(function(){
		$('._211').hide();
		$("#_05").css('margin-top','210px');
		$("#_05").show();
		})
