...
?>
<title>软件视频教程-聚峰网</title>
<meta name="description" content="在这里同学们可以找到各种软件的视频教程，包括信息化办公，机械设计、室内设计、网站设计，影音动画，平面设计，操作系统等。"/>
<meta name="keywords" content="视频教程，聚峰网"/>
<link href="tutorial_topics.css" rel="stylesheet" type="text/css">
</head>
<?php
...
?>
	...
	$i_1=0;
	 foreach($zu as $zu){?>
    <a class="xiaoxiang" href="video_topics.php?category=<?php echo $xiao[$i_1]?>"><?php echo $zu?></a>
 <?php $i_1++;}?>
    </div>
</div>  
