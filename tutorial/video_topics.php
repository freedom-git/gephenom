...
//查专题
$query_category="SELECT * FROM tutorial_category1 WHERE id='$category' LIMIT 1";
$result_category=mysqli_query($dbc,$query_category) or die('出错');
$row_category=mysqli_fetch_array($result_category);
$query1="SELECT * FROM tutorial_category0 WHERE id='$row_category[class0_id]' LIMIT 1";
...
//查专题
//查套
$query_series="SELECT * FROM tutorial_series WHERE id='$series' LIMIT 1";
$result_series=mysqli_query($dbc,$query_series) or die('出错');
$row_series=mysqli_fetch_array($result_series);
//查套
?>
<title><?php echo $row_category['class1']?>视频教程-软件教程-聚峰网</title>
...
<div id="hide">
<?php
$search_query="select * from tutorial WHERE category='$category' AND pass>'0'";
