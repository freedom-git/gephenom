...
//查看是不是上传者
if(!empty($_COOKIE[$row['id'].$_SESSION['session_user_id'].'t'])){$buyornot=1;}
...
?>
<title><?php echo $row['heading']?>视频教程-<?php echo $row2['class1'];?>视频教程-聚峰网</title>
      ...
      <div class="intro_information">
        <div class="intro_details">
          <div class="intro_details_a1">
            ...
            <div class="a1_top">
              <div class="intro_details_a1_img"> <a target="_blank" title="点击查看大图" href="tutorials/<?php echo $title_picture?>"><img alt="<?php echo $row['heading']?>视频教程" src="tutorials/<?php echo $title_picture?>" width="220px" height="140px;" /> </a> </div>
              <div class="a1_top_right">
                ...
                <div class="intro_details_a1_information">
                  <ul class="intro_row2">
                    ...
                    <li class="intro_row2_1">所属专辑：<a  href="/tutorial/video_topics.php?sort=4&category=<?php echo $category?>&type=0&series=<?php echo $series_id?>"><?php echo $series_name?></a></li>
                    <li class="intro_row2_4">
...
//处理播放次数到期
$querydaoqi="SELECT * FROM buy_tutorial WHERE tutorial_id='$id' AND user_id='$_SESSION[session_user_id]' AND times='10' LIMIT 1";
          ...
          <div class="intro_details_a2">
            ...
            <?php if(!empty($row['upload_picture1'])){?>
                  <div class="jietu_con">
                    ...
                    <!--end jianjie_con--> 
                    <div class="jietu"> 
                        <img alt="<?php echo $row['heading']?>视频教程" src="tutorials/<?php echo $row['upload_picture1']?>" width="700px"/><br /><br />
                        <?php }?>
                        <?php if(!empty($row['upload_picture2'])){?>
                        <img alt="<?php echo $row['heading']?>视频教程" src="tutorials/<?php echo $row['upload_picture2']?>" width="700px"/><br /><br />
                        <?php }?>
                        <?php if(!empty($row['upload_picture3'])){?>
                        <img alt="<?php echo $row['heading']?>视频教程" src="tutorials/<?php echo $row['upload_picture3']?>" width="700px"/><br /><br />
                        <?php }?>
                        <?php if(!empty($row['upload_picture4'])){?>
                        <img alt="<?php echo $row['heading']?>视频教程" src="tutorials/<?php echo $row['upload_picture4']?>" width="700px"/><br /><br />
                        <?php }?>
                        <?php if(!empty($row['upload_picture5'])){?>
                        <img alt="<?php echo $row['heading']?>视频教程" src="tutorials/<?php echo $row['upload_picture5']?>" width="700px"/><br /><br />
                        <?php }?>
...
$('.daoqi').bind
	...
	{    if(confirm("您的观看次数已经达到十次，您想要重新购买吗？"))
		{window.location.href="/tutorial/display.php?id=<?php echo $id?>";
         }
});
</script>
          </div>
        </div>
        <div class="intro_ads"><p class="ads_tittle">相关推荐</p>
